...
const ThngTinCNhn = () => {
  return (
    <View style={styles.thngTinKhmChaBnh}>
      <View style={[styles.header, styles.lchSFlexBox]}>
        <Image
      ...
      <View style={styles.thngTinCNhn}>
        <View style={styles.mdiaccountCircleOutlineParent}>
          <Image
            style={[styles.mdiaccountCircleOutlineIcon, styles.iconLayout]}
            contentFit="cover"
            source={require("../assets/mdiaccountcircleoutline1.png")}
          />
        ...
        <View style={styles.hS}>
          ...
          <Image
            ...
            contentFit="cover"
            source={require("../assets/mdiformatlistbulleted.png")}
          />
        </View>
...
sơ`}</Text>
          ...
          <Image
            ...
            contentFit="cover"
            source={require("../assets/materialsymbolslink.png")}
          />
        </View>
...
khỏe`}</Text>
      ...
      <View style={[styles.lchS, styles.lchSFlexBox]}>
        <View style={styles.lchSIuTr}>
          ...
          <Image
            ...
            contentFit="cover"
            source={require("../assets/claritybuildingline1.png")}
          />
