  ...
  return (
    <View style={styles.thngTinCNhn}>
      <View style={styles.frameFlexBox}>
        ...
        />
        <Text style={[styles.hS, styles.hSTypo]}>Hồ Sơ</Text>
      </View>
        ...
        <View style={styles.thngTinHS}>
          <View style={styles.mdiaccountCircleOutlineParent}>
            <Image
              ...
              contentFit="cover"
              source={require("../assets/mdiaccountcircleoutline11.png")}
            />
            <Text style={[styles.anMnhHng, styles.hSTypo]}>AN MẠNH HÙNG</Text>
          </View>
          <View style={[styles.nhIDin, styles.dinPosition]}>
            ...
            <Image
              ...
              contentFit="cover"
              source={require("../assets/bicamera.png")}
            />
          </View>
