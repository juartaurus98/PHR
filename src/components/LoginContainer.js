...
import { FontSize, Color, Border, FontFamily } from "../assets/scss/GlobalStyles";
...
const LoginContainer = memo(() => {
  return (
    <View style={styles.frameNgNhp}>
      ...
      <View style={[styles.frameToTiKhon, styles.frameChildLayout]}>
        <Text style={[styles.toTiKhon, styles.ngNhpTypo]}>Tạo tài khoản</Text>
      </View>
      <View style={[styles.frameNgNhp1, styles.frameChildLayout]}>
